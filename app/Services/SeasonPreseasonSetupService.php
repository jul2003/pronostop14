        ...
        DB::transaction(function () use ($season) {
            ...
            foreach ($templates as $template) {
                ...
                $question = SeasonPreseasonQuestion::create([
                    ...
                    'auto_result_position' => $template->auto_result_position,
                    'points' => $points,
        ...
        DB::transaction(function () use ($sourceSeason, $targetSeason) {
            ...
            foreach ($sourceSeason->preseasonQuestions->sortBy('position') as $sourceQuestion) {
                $targetQuestion = SeasonPreseasonQuestion::create([
                    ...
                    'auto_result_rule' => $sourceQuestion->auto_result_rule,
                    'auto_result_journee_number' => $sourceQuestion->auto_result_journee_number,
                    'auto_result_position' => $sourceQuestion->auto_result_position,
